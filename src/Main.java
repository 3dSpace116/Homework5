public class Main {
    ...
    //Задача 2
        ...
        if (clientDeviceYear>=2015) {
            ...
            else {System.out.println("Установите блегченную версию приложения для Android по ссылке");}}

    // то же самое через 4 строки в 1 этажность
        if (clientDeviceYear>=2015 && clientOS == 0) {System.out.println("Установите версию приложения для iOS по ссылке");}
        if (clientDeviceYear>=2015 && clientOS == 1) {System.out.println("Установите версию приложения для Android по ссылке");}
        if (clientDeviceYear<2015 && clientOS == 0) {System.out.println("Установите облегченную версию приложения для iOS по ссылке");}
        if (clientDeviceYear<2015 && clientOS == 1) {System.out.println("Установите блегченную версию приложения для Android по ссылке");}

    // тернарный, не работает, java: illegal start of expression
    ...
    //Задача 3
        ...
        if (kratnost4 == 0 && kratnost100 != 0 || kratnost400 == 0) {System.out.println(year + " год является високосным");}
